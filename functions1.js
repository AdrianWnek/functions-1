...
let withParase = parseInt(myHeight);
// console.log(withNum);
// console.log(withParase);
...
// .includes()
// console.log(myName.includes('ri'))
...
let noFirstA = myFavVine.replace('a', 'r');
console.log(noFirstA);

let aIsAllGone = myFavVine.replaceAll('a', 'r');
...
// console.log them to see the difference
const tmnt = ['leonardo', 'rafel', 'michaelangelo', 'donatello'];
...
function noPrams() {
    console.log('This function has no parameter!')
}
...
let valueOfFunction = hasReturn(4, 4);
...
const implicit = word => `This arrow functionhas ${word} return`
